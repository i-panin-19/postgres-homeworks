...
SELECT *
FROM orders
WHERE ship_country IN ('France', 'Germany', 'Spain') AND shipped_date IS NOT NULL
...
SELECT AVG(shipped_date-order_date) as total_avg_date
FROM orders
WHERE ship_country IN ('Germany') AND shipped_date IS NOT NULL
